...
"""
酿酒行业:477   医药制造:465  家电行业:465   银行:475  电子元件:459  食品饮料:438  保险:474  机械行业:545  医疗行业: 727  
...
Y_znzjb_value=df_nbfbk_hist_flow['znzjb'].astype(float)
Y_cgbkb_value=df_nbfbk_hist_flow['cgbkb'].astype(float)*10
Y_cgsz_value=df_nbfbk_hist_flow['cgsz'].astype(float)*0.000000000001
...
#p.line(X_Date_value, Y_cgbkb_value, legend_label="今日持股占板块比.", line_width=4)
