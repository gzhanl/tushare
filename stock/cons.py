...
"""
新增的url 20200406 个股资金流
 # em_hist_capital_flow
"""
#EM_HCF_URL =  'http://ff.eastmoney.com//EM_CapitalFlowInterface/api/js?type=hff&rtntype=2&js=({data:[(x)]})&cb=var%20aff_data=&check=TMLBMSPROCR&acces_token=1942f5da9b46b069953c873404aad4b5&id=6003051'
...
EM_NBFBKSTS_URL='%sdcfm.%s/EM_MutiSvcExpandInterface/api/js/get?type=HSGT20_HYTJ_SUM&token=894050c76af8597a853f5b408b759f5d&st=ShareSZ_ZC&sr=-1&p=1&ps=100&js=var%20TwnWmGdX={pages:(tp),data:(x)}&filter=(DateType=%271%27)'
